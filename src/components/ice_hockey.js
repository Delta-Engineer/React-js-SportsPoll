...
export default class IceHockey extends React.Component {
    ...
    state = {
        ...
        teamImages:[
            "https://vignette.wikia.nocookie.net/internationalhockey/images/d/d9/Zuralie_Kurgan_logo.png/revision/latest?cb=20140601191831",
            "https://upload.wikimedia.org/wikipedia/en/4/4b/THK_logo.png",
   ...
   render(){
    ...
    switch(this.state.match){
        case "Zauralie Kurgan - THK Tver":  teamArray = 0 ;break
        ...
        <header className="Body-header">
            <div>
                 ...
                 <button className = "Button-style" onClick={()=> {this.setState({match: "Zauralie Kurgan - THK Tver", resetState: true} ) }} >Zauralie Kurgan - THK Tver</button>
